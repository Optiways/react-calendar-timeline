  ...
  _createClass(Columns, [{
    ...
    value: function render() {
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        var minUnitValue = _calendar.getUnitValue[minUnit](time);
        ...
        var classNames = 'rct-vl' + (firstOfType ? ' rct-vl-first' : '') + (minUnit === 'day' || minUnit === 'hour' || minUnit === 'minute' ? " rct-day-".concat(time.getDay(), " ") : ' ') + classNamesForTime.join(' ');
