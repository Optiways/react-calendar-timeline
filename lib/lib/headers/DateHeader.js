  ...
  function DateHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getLabelFormat", function (interval, unit, labelWidth) {
      ...
      if (typeof labelFormat === 'string') {
        ...
        return (0, _dateFns.intlFormat)(startTime, {
          locale: labelFormat
        });
      } else if (_typeof(labelFormat) === "object") {
        var _startTime = interval[0];
        return (0, _dateFns.intlFormat)(_startTime, labelFormat);
...
function formatLabel(_ref3, unit, labelWidth) {
  ...
  return (0, _dateFns.intlFormat)(timeStart, format);
}
