...
exports.minCellWidth = exports.setUnitStart = exports.setUnitValue = exports.getUnitValue = void 0;
...
var getUnitValue = {
  'year': _dateFns.getFullYear,
  'month': _dateFns.getMonth,
  'week': _dateFns.getWeek,
  'day': _dateFns.getDate,
  'hour': _dateFns.getHours,
  'minute': _dateFns.getMinutes,
  'second': _dateFns.getSeconds
};
exports.getUnitValue = getUnitValue;
var setUnitValue = {
  'year': _dateFns.setYear,
  'month': _dateFns.setMonth,
  'week': _dateFns.setWeek,
  'day': _dateFns.setDate,
  'hour': _dateFns.setHours,
  'minute': _dateFns.setMinutes,
  'second': _dateFns.setSeconds
};
exports.setUnitValue = setUnitValue;
var setUnitStart = {
  'year': _dateFns.startOfYear,
  'month': _dateFns.startOfMonth,
  'week': _dateFns.startOfWeek,
  'day': _dateFns.startOfDay,
  'hour': _dateFns.startOfHour,
  'minute': _dateFns.startOfMinute,
  'second': _dateFns.startOfSecond // | `unit`| `second`, `minute`, `hour`, `day`, `week`, `month`, `year` intervals between columns |

};
exports.setUnitStart = setUnitStart;

function iterateTimes(start, end, unit, timeSteps, callback) {
  var time = setUnitStart[unit](start);
  ...
  while (time.valueOf() < end) {
    var nextTime = setUnitValue[unit](new Date(time), getUnitValue[unit](time) + (timeSteps[unit] || 1));
